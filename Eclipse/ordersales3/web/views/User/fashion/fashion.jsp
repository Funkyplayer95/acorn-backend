...
<body>
	<a href="http://localhost:8090/ordersales/views/User/usermenu.jsp" ><h1> JinDoBay - 전자 제품 </h1></a> 
		...
		<table border="1">
            ...
            <c:forEach var="goodsList" items="${goodsList}">
				<tr>
					...
					<td>
						<form action="http://localhost:8090/ordersales/produpdate" method="GET" onsubmit="return isbuy();">
