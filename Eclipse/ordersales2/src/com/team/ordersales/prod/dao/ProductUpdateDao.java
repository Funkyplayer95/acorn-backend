...
public class ProductUpdateDao {
	...
	public static List<ProductInfoEntity> productupdate(String GoodsCode, String sCategory){
		
		String sql = "UPDATE INSALESGOODS SET RAWMATERIALQTY = RAWMATERIALQTY-1 WHERE GOODSCODE = ?";
		String sql2 = "UPDATE ORDERGOODS SET RAWMATERIALQTY = RAWMATERIALQTY-1 WHERE GOODSCODE = ?";
		String sql3 = "UPDATE STOCKINFO SET RAWMATERIALQTY = RAWMATERIALQTY-1 WHERE rawMaterialCode = ?";
