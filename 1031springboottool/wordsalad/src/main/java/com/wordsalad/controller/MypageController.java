...
public class MypageController {
	...
	public String changePassword(@RequestParam("id") String id, Model model) {
		UserDto userDto = mypageService.getuserInfo(id);
		model.addAttribute("id", userDto.getId());
		return "changepw";
	}
	@PostMapping("/Mypage/changepw2")
	public String changePassword2(@RequestParam("id") String id, @RequestParam("pw") String pw,
	...
	public String changeNickName(@RequestParam("id") String id, Model model) {
		UserDto userDto = mypageService.getuserInfo(id);
		model.addAttribute("id", userDto.getId());
	...
	public String changeNickName(@RequestParam("id") String id, @RequestParam("pw") String pw,
