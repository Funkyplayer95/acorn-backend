...
<body>
	...
	<div id=headerWrap>
		...
		<div>
			<h1>
				<a href="/ordersales/views/Admin/adminmenu.jsp">관리자 메뉴 - 재고 조회</a>
			</h1>
		</div>
		<div id=header2>
				...
				<tr>
					...
					<td>
						<form action="/ordersales/stockinfo4" method="get"
							onsubmit="return is_fill('${stockInfo.rawmaterialname}');">
							<input type='number' min='1' value='0'
								id='${stockInfo.rawmaterialname}' name='little_full'
								class='smallbtn' /> <input type='submit' value='채우기'
...
<script>
	function is_fill(xx/* = ${stockInfo.rawmaterialname}*/) {
		var i = document.getElementById(xx).value; /* 입력된 갯수량의 수를 가지고 오기 위해 필요한 함수 */
