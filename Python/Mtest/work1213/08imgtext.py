...
img = cv2.imread(path)
cv2.putText(img, 'HB winter test ', (30,70), cv2.FONT_HERSHEY_SIMPLEX | cv2.FONT_ITALIC  ,2, (0,0,0))
cv2.putText(img, 'HB spring test ', (30,130), cv2.FONT_HERSHEY_SIMPLEX | cv2.FONT_ITALIC  ,2, (0,0,0))
cv2.putText(img, 'HB python test ', (30,200), cv2.FONT_HERSHEY_SIMPLEX | cv2.FONT_ITALIC  ,2, (0,0,0))
